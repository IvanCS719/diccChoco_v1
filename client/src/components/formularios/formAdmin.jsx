        ...
        <div className='container px-4 lg:px-0 min-h-screen'>
            ...
            <>
                ...
                >
                    {({ values, errors }) => (
                        <Form >
                            <div className='w-full p-4 mt-3 bg-white rounded-2xl shadow-mfBoxShadow'>
                                ...
                                <div className='w-full flex flex-col xl:flex-row gap-4'>
                                    ...
                                    <div className='w-full'>
                                        <div className='w-full flex justify-between flex-col gap-2 md:gap-0 xl:flex-row items-center'>
                                            <div className='text-left md:mb-2 xl:mr-24'>
                                ...
                                >
                                    <div className="bg-white w-80 lg:w-auto p-5 rounded-xl shadow-mfBoxShadow border">
                                        ...
                                        <p className="text-lg text-gray-700 font-medium mb-4">La palabra se ha agregado exitosamente al diccionario<br />del choco.</p>
